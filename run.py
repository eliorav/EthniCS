...
def generate_simulation_experiments(output_folder:Path='./simulations_output', no_ethnics:bool=False, ethnics_config_file:Path='./EthniCS_config.json'):
    """
...
def generate_real_data_experiments(ethnicity_file_path:Path='./data/1000g_ethnicities.csv', output_folder:Path='./read_data_output', no_ethnics:bool=False, ethnics_config_file:Path='./EthniCS_config.json'):
    """
...
def generate_super_population_experiments(ethnicity_file_path:Path='./data/1000g_super_pop_ethnicities.csv', output_folder:Path='./super_population_output', no_ethnics:bool=False, ethnics_config_file:Path='./EthniCS_config.json'):
    """
